...
$GLOBALS['TL_LANG']['tl_content']['wt_complete_tags'] = array('Complete tags', 'Please choose html tags and set their attributes. Remark: A good "void tag" example is &lt;img&gt; - it does not need to be closed to be correct (in HTML5 syntax).');
